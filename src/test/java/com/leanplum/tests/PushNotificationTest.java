...
//    }
    ...
    // Only for iOS
    @Test(description = "Push Notification's with iOS options")
    public void pushNotWithIOSOptions(Method method) {
        ...
        stepHelper.verifyCondition("Verify that notification contains subtitle", pushNotification.doesContainContent("Push notification with iOS options subtitle"));
        
        stepHelper.verifyCondition("Verify that notification contains title", pushNotification.doesContainContent("Push notification with iOS options title"));

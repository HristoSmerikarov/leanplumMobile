...
public class PushNotificationTest extends CommonTestSteps {
    ...
    public void pushNotOpenActionWNewAction(Method method) {
        ...
        PushNotificationUtils pushNotification = new PushNotificationUtils(driver, RONDO_PUSH_NOTIFICATION);
...
//    }
    ...
    private void openNotificationsAndOpenByMessage(MobileDriver<MobileElement> driver, TestStepHelper stepHelper,
            PushNotificationUtils pushNotification) {
    	if (driver instanceof AndroidDriver) {
    		stepHelper.openAndroidNotifications();
            stepHelper.waitForAndroidNotificationPresence(pushNotification);
            stepHelper.openAndroidPushNotification(pushNotification);
		}else {

...
public class NAppSetupPO extends AppSetupPO {
    ...
    public NAppSetupPO(AppiumDriver<MobileElement> driver) {
        super(driver);
        this.driver = driver;
    ...
    public String getUserId() {
        return getTextFromElement(userId);
    }

    @Override
    public String getDeviceId() {
        return getTextFromElement(deviceId);
    }
    ...
    public void waitForDeviceIdIUpdate(String expectedDeviceId) {
        MobileDriverUtils.waitForExpectedCondition(driver, 30,
                ExpectedConditions.textToBePresentInElement(deviceId, expectedDeviceId));
    }
}

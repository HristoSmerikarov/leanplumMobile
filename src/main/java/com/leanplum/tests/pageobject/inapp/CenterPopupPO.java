...
public class CenterPopupPO extends InAppPopupPO {
	...
	private static final String IOS_CENTER_POPUP_XPATH = "//" + IOS_STATIC_TEXT_XPATH + "/following-sibling::"
			+ IOS_STATIC_TEXT_XPATH + "/following-sibling::" + IOS_BUTTON_XPATH + "/ancestor::XCUIElementTypeOther[2]";
	...
	@iOSXCUITFindBy(xpath = IOS_CENTER_POPUP_XPATH + "/"+IOS_BUTTON_XPATH)

...
public class NConfirmInAppPO extends ConfirmInAppPO {
    ...
    public NConfirmInAppPO(AppiumDriver<MobileElement> driver) {
        super(driver);
        this.driver = driver;
    ...
    public boolean verifyConfirmInApp(String title, String message, String acceptButtonText, String cancelButtonText) {
        ...
        return verifyInAppPopup(driver, ImmutableMap.of(confirmInAppTitle, title, confirmInAppMessage, message,

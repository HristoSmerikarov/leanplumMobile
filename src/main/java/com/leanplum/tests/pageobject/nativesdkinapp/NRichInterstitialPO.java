...
public class NRichInterstitialPO extends RichInterstitialPO {
    ...
    public NRichInterstitialPO(AppiumDriver<MobileElement> driver) {
        super(driver);
        this.driver = driver;
    ...
    public boolean verifyRichInterstitial(String title, String message, String leftButtonText, String rightButtonText,
        ...
        return hasCloseButton == isCloseButtonPresent() && verifyInAppPopup(driver,
                ImmutableMap.of(richInterstitialTitle, title, richInterstitialMessage, message,

...
public class NInterstitialPO extends InterstitialPO {
    ...
    public NInterstitialPO(AppiumDriver<MobileElement> driver) {
        super(driver);
        this.driver = driver;
    ...
    public boolean verifyInterstitialLayout(String interstitialTitle, String interstitialMessage, String acceptButton) {
        ...
        return isInterstitialLayoutCorrect()
                && verifyInAppPopup(driver, ImmutableMap.of(interstitialTitleElement, interstitialTitle,

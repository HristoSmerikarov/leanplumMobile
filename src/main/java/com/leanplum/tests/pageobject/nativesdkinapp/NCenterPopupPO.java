...
public class NCenterPopupPO extends CenterPopupPO {
    ...
    public NCenterPopupPO(AppiumDriver<MobileElement> driver) {
        super(driver);
        this.driver = driver;
    ...
    public boolean verifyCenterPopup(String title, String message, String buttonText) {
        ...
        return verifyInAppPopup(driver, ImmutableMap.of(centerPopupTitle, title, centerPopupMessage, message,
                centerPopupAcceptButton, buttonText));
    }
